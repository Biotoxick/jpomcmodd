...
import jpomc.procedures.CpcCdialogueProcedure;

import jpomc.init.JpomcModEntities;

public class NPCCEntity extends PathfinderMob {
	public NPCCEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JpomcModEntities.NPCC.get(), world);
	}

	public NPCCEntity(EntityType<NPCCEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CpcCdialogueProcedure.execute(world, sourceentity);
		return retval;
	}
