...
import jpomc.procedures.NpcBdialogueProcedure;
import jpomc.procedures.NPCAEntityIsHurtProcedure;

import jpomc.init.JpomcModEntities;

public class NPCBEntity extends PathfinderMob {
	public NPCBEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JpomcModEntities.NPCB.get(), world);
	}

	public NPCBEntity(EntityType<NPCBEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		NpcBdialogueProcedure.execute(world, sourceentity);
		return retval;
	}
