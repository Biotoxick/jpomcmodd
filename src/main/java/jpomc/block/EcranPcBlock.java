...
import jpomc.procedures.ReplacescreenProcedure;
...
public class EcranPcBlock extends Block {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		ReplacescreenProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 20);
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(JpomcModBlocks.ECRAN_PC.get(), renderType -> renderType == RenderType.cutout());
	}
}
