...
public class ChassisVideBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ChassisVideBlockEntity(BlockPos position, BlockState state) {
		super(JpomcModBlockEntities.CHASSIS_VIDE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("chassis_vide");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new BoitierpcguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
