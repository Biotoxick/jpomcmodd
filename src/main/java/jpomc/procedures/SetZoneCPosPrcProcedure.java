...
public class SetZoneCPosPrcProcedure {
		...
		if (file.exists()) {
			{
				try {
					...
					mainobj.addProperty("ZoneC X pos", (entity.getX()));
					mainobj.addProperty("ZoneC Y pos", (entity.getY()));
					mainobj.addProperty("ZoneC Z pos", (entity.getZ()));
					{
					...
					if (entity instanceof Player _player && !_player.level.isClientSide())
						_player.displayClientMessage(
								new TextComponent("Position de la zone C chang\u00E9e /jpomcreload pour valider les changements"), (false));
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
