...
public class ZoneCtpProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			Entity _ent = entity;
			_ent.teleportTo(JpomcModVariables.zoneCX, JpomcModVariables.zoneCY, JpomcModVariables.zoneCZ);
			if (_ent instanceof ServerPlayer _serverPlayer)
				_serverPlayer.connection.teleport(JpomcModVariables.zoneCX, JpomcModVariables.zoneCY, JpomcModVariables.zoneCZ, _ent.getYRot(),
						_ent.getXRot());
		}
