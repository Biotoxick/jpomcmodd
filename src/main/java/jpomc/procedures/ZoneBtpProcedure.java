...
public class ZoneBtpProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			Entity _ent = entity;
			_ent.teleportTo(JpomcModVariables.zoneBX, JpomcModVariables.zoneBY, JpomcModVariables.zoneBZ);
			if (_ent instanceof ServerPlayer _serverPlayer)
				_serverPlayer.connection.teleport(JpomcModVariables.zoneBX, JpomcModVariables.zoneBY, JpomcModVariables.zoneBZ, _ent.getYRot(),
						_ent.getXRot());
		}
