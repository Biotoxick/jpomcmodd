...
public class ZoneDtpProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			Entity _ent = entity;
			_ent.teleportTo(JpomcModVariables.zoneDX, JpomcModVariables.zoneDY, JpomcModVariables.zoneDZ);
			if (_ent instanceof ServerPlayer _serverPlayer)
				_serverPlayer.connection.teleport(JpomcModVariables.zoneDX, JpomcModVariables.zoneDY, JpomcModVariables.zoneDZ, _ent.getYRot(),
						_ent.getXRot());
		}
