...
@Mod("jpomc")
public class JpomcMod {
	public static final Logger LOGGER = LogManager.getLogger(JpomcMod.class);
	public static final String MODID = "jpomc";
	...
	public JpomcMod() {
		...
		JpomcModEntities.REGISTRY.register(bus);
