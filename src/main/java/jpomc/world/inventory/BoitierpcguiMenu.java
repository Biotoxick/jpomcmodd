...
public class BoitierpcguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BoitierpcguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
